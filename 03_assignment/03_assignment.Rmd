...
\begin{tabular}{lcc}
   ...
   \midrule
   \emph{Variables}\\
   SPEI4pg                         & 0.0346$^{***}$  & 0.0103\\   
                                   & (0.0053)        & (0.0149)\\   
   L1\_SPEI4pg                     & 0.0026          & 0.0131\\   
                                   & (0.0049)        & (0.0135)\\   
   L2\_SPEI4pg                     & 0.0104$^{**}$   & -0.0097\\   
                                   & (0.0049)        & (0.0140)\\   
   GSmain\_ext\_SPEI4pg            & -0.0338$^{***}$ & -0.0058\\   
                                   & (0.0088)        & (0.0158)\\   
   L1\_GSmain\_ext\_SPEI4pg        & -0.0321$^{***}$ & -0.0433$^{***}$\\   
                                   & (0.0081)        & (0.0158)\\   
   L2\_GSmain\_ext\_SPEI4pg        & -0.0348$^{***}$ & -0.0240\\   
                                   & (0.0085)        & (0.0156)\\   
   W\_L2\_GSmain\_ext\_SPEI4pg     &                 & -0.0026\\   
                                   &                 & (0.0026)\\   
   W\_L1\_GSmain\_ext\_SPEI4pg     &                 & 0.0021\\   
                                   &                 & (0.0026)\\   
   W\_GSmain\_ext\_SPEI4pg         &                 & -0.0056$^{**}$\\   
                                   &                 & (0.0027)\\   
   W\_SPEI4pg                      &                 & 0.0043$^{*}$\\   
                                   &                 & (0.0023)\\   
...
In both the horizontal and the vertical contiguity matrix the average degree is about 1.86 and 2.09. Thus most cells have (as expected) two neighbors but some cells , at the edge, have only one neighbors. Moreover, some cells even have more than two neighbors. This is because the condition that any cells is being assigned neighborhood status who's centroid is less than 180 kilometers away can include more than one neighbor. This implies that the networks are sparser and less dense than the adjacency matrix used by the authors. This is also reflected in lower 'graph density' for the horizontal and vertical contiguity matrix as compared to the baseline adjacency matrix. Visualizing the spatial weight matrices further corroborates the sparser structure. 
