...
Alternatively, this could be also done by hand by including the dummies for both fixed effects.
...
Allowing for spatial error, the spatial lag dependence is not significant. Thus this classical specification search suggests estimating the SEM model. 
