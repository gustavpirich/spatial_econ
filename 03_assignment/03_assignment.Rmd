...
pacman::p_load(spatialreg, patchwork, gridExtra, fixest, splm, stringi, stringr, stringdist, haven, sf, dplyr, fuzzyjoin, 
...
R$^{2}$ & 0.895 \\ 
Adjusted R$^{2}$ & 0.889 \\ 
Residual Std. Error & 0.075 (df = 1303) \\ 
F Statistic & 146.915$^{***}$ (df = 76; 1303) \\ 
\hline 
\hline \\[-1.8ex] 
...
```{r, figure.height = 3, figure.width = 2}
