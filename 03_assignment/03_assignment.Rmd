...
pacman::p_load(spatialreg, splm, stringi, stringr, stringdist, haven, sf, dplyr, fuzzyjoin, 
...
#nblist <- dnearneigh(x = st_centroid(raster_Africa), d1 = 0, d2 = 180)
...
blmpSDPD(ANY_EVENT_ACLED ~ SPEI4pg + L1_SPEI4pg + L2_SPEI4pg, model = list("sdm"), index = c("cell", "year"), dynamic = TRUE, W = listw, data = geoconflict_main)
