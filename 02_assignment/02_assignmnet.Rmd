...
l_dist_w_matrix <- mat2listw(dist_w_matrix)

l_decay_weights_matrix <- mat2listw(decay_weights_matrix)

l_contig_w_matrix <- mat2listw(contig_w_matrix, zero.policy = TRUE)
